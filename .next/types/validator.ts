...
// Validate ../../app/api/send-registration-email/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/send-registration-email">> = Specific
  const handler = {} as typeof import("../../app/api/send-registration-email/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
